            ...
            <div>
                <div class="flex h-screen bg-gray-100">
                    <div class="m-auto">
                        <div>
                            {{-- FORMULARIO --}}
                            <form action="{{ route('permisos.update', ['permiso' => $usuario->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mt-5 bg-white rounded-lg shadow">
                                    <div class="flex">
                                        <div class="flex-1 py-5 pl-5 overflow-hidden">
                                            ...
                                            <h1 class="inline text-2xl font-semibold leading-none">Editar Usuario</h1>

                                            <h5 class="inline text-2xl font-semibold leading-none">{{ $usuario->nombre }}
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="px-5 pb-5">
